...
// // Theme Provider (you'll need to add this to your main.dart)
...
//         // Navigate to login screen - adjust this according to your app structure
...
//         //     .child('${widget.userProfile.uid}.jpg');
...
//       );
//       await FirebaseAuth.instance.currentUser?.updatePhotoURL(_profileImageUrl);
...
//                         Text(
//                           'Member since: ${_formatDate(widget.userProfile.createdAt)}',
//                           style: TextStyle(
//                             color: Colors.grey[600],
//                             fontSize: 14,
//                           ),
